...
y_pred_baseline = randomforest.predict(x_test)
print(f"baseline1:")
...
randomforest_2 = RandomForestClassifier(random_state=42, n_estimators=100)
randomforest_2.fit(x_train, predicted_labels)

y_pred_baseline = randomforest_2.predict(x_test)
print(f"baseline2:")
print(classification_report(y_test, y_pred_baseline, digits=4))

y_pred_proba_baseline_2 = randomforest_2.predict_proba(x_test)
...
ours = RandomForestClassifier(random_state=42, n_estimators=100)
