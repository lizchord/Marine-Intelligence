...
svm_linear = svm.SVC(C=1, probability=True, kernel="rbf", decision_function_shape="ovr")
...
y_pred_proba = svm_linear.predict_proba(x_test)
...
clf = svm.SVC(C=1, probability=True, kernel="rbf", decision_function_shape="ovr")
...
svm_linear_2 = svm.SVC(C=1, probability=True, kernel="rbf", decision_function_shape="ovr")
svm_linear_2.fit(x_train, predicted_labels)

y_pred_baseline = svm_linear_2.predict(x_test)
print(f"baseline2:")
print(classification_report(y_test, y_pred_baseline, digits=4))

y_pred_proba_baseline_2 = svm_linear_2.predict_proba(x_test)
...
ours = svm.SVC(C=1, probability=True, kernel="rbf", decision_function_shape="ovr")
