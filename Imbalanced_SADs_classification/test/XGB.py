...
y_pred_baseline = XGB.predict(x_test)
print(f"baseline1:")
...
XGB_2 = XGBClassifier()
XGB_2.fit(x_train, predicted_labels)

y_pred_baseline = XGB_2.predict(x_test)
print(f"baseline2:")
print(classification_report(y_test, y_pred_baseline, digits=4))

y_pred_proba_baseline_2 = XGB_2.predict_proba(x_test)
