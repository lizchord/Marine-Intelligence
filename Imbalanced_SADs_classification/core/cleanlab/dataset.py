...
import numpy as np
import pandas as pd
from core.cleanlab.count import estimate_joint
...
def overall_label_health_score(
    ...
    **Parameters**: For parameter info, see the docstring of :py:func:`find_overlapping_classes <cleanlab.dataset.find_overlapping_classes>`.
    ...
    return joint, indices#joint_trace
...
def health_summary(
    ...
    **Parameters**: For parameter info, see the docstring of :py:func:`find_overlapping_classes <cleanlab.dataset.find_overlapping_classes>`.
    ...
    """
    from core.cleanlab.internal.util import smart_display_dataframe
